  ...
  const fetchProducts = async () => {
    try {
      ...
      if (response.data.success) {
        console.log('🟢 5. Products count:', response.data.products.length);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.navButton} onPress={() => router.push('/messages')}>
        ...
        <TouchableOpacity style={styles.navButton} onPress={() => router.push('/screens/profile')}>
          <Text style={styles.navIconInactive}>👤</Text>
        </TouchableOpacity>
      </View>
